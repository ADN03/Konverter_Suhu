package com.example.adni_gumilang.konvertersuhu;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        celcius = (EditText)findViewById(R.id.edxt_celcius);
        kelvin = (EditText)findViewById(R.id.edxt_kelvin);
        farenheit = (EditText)findViewById(R.id.edxt_farenheit);
        reamur = (EditText)findViewById(R.id.edxt_reamur);
